...
answer_label = Label(text = numbers[:6])
answer_label.grid(row = 1, column = 1)

bonus_label = Label(text = numbers[-1])
bonus_label.grid(row = 1, column = 2)

my_label = Label(text = "내 번호")
my_label.grid(row = 2, column = 0)

rank_1 = Label(text = "1등")
rank_1.grid(row = 3, column = 0)
rank_1_count = Label(text = "0")
rank_1_count.grid(row = 3, column = 2)

rank_2 = Label(text = "2등")
rank_2.grid(row = 4, column = 0)
rank_2_count = Label(text = "0")
rank_2_count.grid(row = 4, column = 2)

rank_3 = Label(text = "3등")
rank_3.grid(row = 5, column = 0)
rank_3_count = Label(text = "0")
rank_3_count.grid(row = 5, column = 2)

rank_4 = Label(text = "4등")
rank_4.grid(row = 6, column = 0)
rank_4_count = Label(text = "0")
rank_4_count.grid(row = 6, column = 2)

rank_5 = Label(text = "5등")
rank_5.grid(row = 7, column = 0)
rank_5_count = Label(text = "0")
rank_5_count.grid(row = 7, column = 2)

rank_6 = Label(text = "X")
rank_6.grid(row = 8, column = 0)
rank_6_count = Label(text = "0")
rank_6_count.grid(row = 8, column = 2)
